namespace ProyectoHCL.Formularios
{
    partial class Backup
    {
        ...
        private void InitializeComponent()
        {
            ...
            label11.Location = new Point(552, 35);
            label11.Margin = new Padding(4, 0, 4, 0);
            label11.Name = "label11";
            label11.Size = new Size(304, 45);
            label11.TabIndex = 19;
            ...
            Generar_Backup.Font = new Font("Century Gothic", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            Generar_Backup.ForeColor = Color.White;
            Generar_Backup.Location = new Point(567, 140);
            Generar_Backup.Margin = new Padding(4, 5, 4, 5);
            Generar_Backup.Name = "Generar_Backup";
            Generar_Backup.Size = new Size(201, 47);
            ...
            label6.Location = new Point(501, 72);
            label6.Margin = new Padding(4, 0, 4, 0);
            label6.Name = "label6";
            label6.Size = new Size(355, 28);
            label6.TabIndex = 5;
            label6.Text = "Nombre de la Base de Datos:";
