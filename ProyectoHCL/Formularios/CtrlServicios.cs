...
namespace ProyectoHCL.Formularios
{
    public partial class CtrlServicios : Form
    {
        ...
        private void dgvServ_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)  //Configurar datagrid para mostrar los botones de editar y eliminar que se agregaron
        {
