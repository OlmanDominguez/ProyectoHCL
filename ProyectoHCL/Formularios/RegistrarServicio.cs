    ...
    public partial class RegistrarServicio : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    if (modelo.existeServicio(txtDesc.Text))
                    {
                        MessageBox.Show("El servicio ya existe", "Aviso",
                         MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
                    else
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        MessageBox.Show("Servicio creado con éxito", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        limpiarCampos();
                        conn.Close();
                    }
